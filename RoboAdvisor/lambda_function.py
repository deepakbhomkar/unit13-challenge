    ...
    if age is not None: 
        ...
        if age <= 0:
            return build_validation_result(
                False, 
                'age', 
                'Age cannot be negative, please provide a valid age'
            )
        if age > 65: 
            return build_validation_result(
                False, 
                'age', 
                'The maximum age to contract this service is 65, can you '
                'please provide an age between 1 and 65?'
            )
    ...
    if investmentAmount is not None: 
        ...
        if investmentAmount < 5000: 
            return  build_validation_result(
                ...
                'can you please provide a greater amount to invest?'
            )
